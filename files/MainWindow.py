...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_54.setMinimumSize(QtCore.QSize(800, 35))
        self.label_54.setMaximumSize(QtCore.QSize(800, 16777215))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        ...
        self.gridLayout_13.addWidget(self.label_59, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_54.setText(_translate("MainWindow", "<html><head/><body><p>Введите количество лет, на протяжении которых проводилось наблюдение:</p></body></html>"))
